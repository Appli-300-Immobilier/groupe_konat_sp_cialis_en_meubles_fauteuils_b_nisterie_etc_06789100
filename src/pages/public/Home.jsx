...
const Home = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      subtitle:
        'Groupe Konat� sp�cialis� en meubles,fauteuils,�b�nisterie,etc 06789100 accompagne le développement industriel et domestique avec des solutions innovantes et durables.',
